...
import { UpdateFileTitleModal } from "../../Providers/Modals/UpdateFileTitleModal";
...
export const EditorContainer = ({ fileId, folderId, runCode }) => {
  ...
  const defaultLanguage = getLanguage(fileId, folderId);

  // console.log("File ID:", fileId, "Folder ID:", folderId);
  // console.log("File Title:", getFileTitle(fileId, folderId));
